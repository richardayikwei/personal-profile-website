...
const ArticleCards = (project: ArtcleProps) => {
  return (
    <div className="text-[#1e3956] shadow-2xl md:rounded-3xl bg-white space-y-6 md:max-w-[300px]">
      <figure>
        <img
          src={project.article.image}
          alt={project.article.title}
          className=" md:rounded-t-3xl md:w-[18.75rem] md:h-[16.4rem] w-96 h-[11.9rem]"
        />
      </figure>
      ...
      <article className="mx-auto flex flex-col w-[90%] h-2/3">
        ...
        <div className=" h-[50px] mt-10 text-[18px] leading-relaxed">
